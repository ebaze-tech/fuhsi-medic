...
const pdfController = async (req, res) => {
    ...
    filePath = path.join(__dirname, '..', 'admin_questionnaire_files', fileName);
...
const pdfDownloadController = async (req, res) => {
    ...
    try {
        ...
        const filePath = path.join(__dirname, '..', "users'_downloaded_files", fileName);
        ...
        doc
            .text(
                `Matric No: ${form.matricNo} | Jamb Reg No: ${form.jambRegNo}`,
                { align: "left" }
            )
            .moveDown(0.5);
        doc
...
const pdfUpdateController = async (req, res) => {
    ...
    try {
        ...
        filePath = path.join(__dirname, '..', 'admin_updated_questionnaire_files', fileName);
